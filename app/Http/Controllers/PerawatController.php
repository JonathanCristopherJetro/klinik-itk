    ...
    public function storeAnamnesis(Request $request)
    {
        ...
        Anamnesis::updateOrCreate(
            ...
            [
                ...
                'is_menyusui' => $validated['is_menyusui'] ?? false,
                ...
                'jenis_gula_darah' => $validated['jenis_gula_darah'] ?? null,
